...
#define DIST_LUNA_1 1
#define DIST_LUNA_2 1.5

static GLfloat tierra_rotacion = 0.0;
static GLfloat tierra_orbita   = 0.0;
static GLfloat luna_orbita_1   = 0.0;
static GLfloat luna_orbita_2   = 0.0;  
static GLfloat luna_rotacion_2 = 0.0;
...
void render () { 
  ...
  glPushMatrix();
    glRotatef(luna_orbita_1, 0.0, 0.0, 1.0);
    glTranslatef(DIST_LUNA_1, 0.0, 0.0);
  ...
  glPushMatrix();
    glRotatef(luna_orbita_2, 0.0, 0.0, 1.0);
    glTranslatef(DIST_LUNA_2, 0.0, 0.0);
    glRotatef(luna_rotacion_2, 0.0, 0.0, 1.0);

    glColor3ub(0, 255, 0);
    glutWireSphere(0.18, 4, 4);
  glPopMatrix();
